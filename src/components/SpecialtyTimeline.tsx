      ...
      <div className="border border-gray-200 dark:border-neutral-800 rounded-2xl overflow-hidden">
        ...
        <div className="px-6 py-8 overflow-x-auto">
          <div className="relative min-w-[640px]">
            ...
            <div
              className="absolute h-px bg-gray-200 dark:bg-neutral-700"
            ...
            <div className="relative flex">
              {stops.map(({ when, label, note }, i) => (
                <div key={label} className="flex-1 flex flex-col items-center px-2">
                  <span className="text-[9px] font-mono text-gray-400 dark:text-neutral-500 mb-2 h-3">
                    {when}
                  </span>
                  <span
                  ...
                  <div className="mt-3 text-center max-w-[11rem]">
                    <div className="text-[11px] font-semibold text-gray-800 dark:text-neutral-200 leading-snug">
                      {label}
                    </div>
                    {note && (
                      <div className="text-[9px] font-mono text-gray-400 dark:text-neutral-500 mt-1 leading-snug">
                        {note}
                      </div>
                    )}
                  </div>
