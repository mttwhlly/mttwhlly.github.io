        ...
        <div className="p-6 sm:p-8">
          <div className="flex gap-3">
            ...
            <div className="shrink-0 flex flex-col justify-between items-center py-1 w-4">
              ...
              <span
                className="text-[9px] font-mono uppercase tracking-widest text-gray-400 dark:text-neutral-500 whitespace-nowrap"
            ...
            <div className="flex-1 min-w-0">
              <div className="relative aspect-square w-full max-w-md mx-auto">
                ...
                <div className="absolute inset-0 border border-gray-200 dark:border-neutral-800 rounded-xl overflow-hidden">
                  ...
                  <div className="absolute top-2 right-2.5 text-right">
                    <span className="text-[9px] font-mono text-gray-500 dark:text-neutral-400">
                      MCP earns its keep
                    </span>
                  </div>
                  <div className="absolute bottom-2 left-2.5">
                    <span className="text-[9px] font-mono text-gray-400 dark:text-neutral-500">
                      MCP adds overhead
                    </span>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between max-w-md mx-auto mt-2 px-0.5">
                <span className="text-[9px] font-mono text-gray-400 dark:text-neutral-500">low</span>
                ...
                <span className="text-[9px] font-mono text-gray-400 dark:text-neutral-500">high</span>
              </div>
            </div>
          </div>
        </div>
