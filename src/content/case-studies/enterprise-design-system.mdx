...
description: >
  A 1.6M-instance design system was being used to generate UI with AI, but there was no reliable way
  to know which components mapped to production code. I built the infrastructure to measure,
  classify, and distribute that truth.
publishedDate: '2026'
order: 0
tags:
  - Design Systems
