...
const $$Debug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Debug;
  const environment = Object.assign(__vite_import_meta_env__, { SPOTIFY_CLIENT_ID: "***REMOVED***", SPOTIFY_CLIENT_SECRET: "***REMOVED***", SPOTIFY_REFRESH_TOKEN: "AQA1r5Vp1w0J9AL0O8a3vZpwBn5R9st6lWKJvBSWcDkCplC8XTqC5QS4cH3TnhJGnfP-xtJ2oFTd2wMzvX_ouLbQkMIQJ_k-hHv3i1JHguobR2AlS86SbkLEpDO3vDnu1Yw" });
